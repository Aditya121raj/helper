    ...
    >
      ...
      >
        ...
        >
          ...
          {/* NoView logo - no container, just the logo */}
            ...
            {commands.map((command, index) =>
              command.show ? (
                ...
                >
                  {command.id === "voice" ? (
                    <div
                      className="flex flex-col justify-center gap-px px-1"
                      title="System Voice: Ctrl + M\nMic Voice: Ctrl + Shift + M"
                      aria-label="System Voice Ctrl plus M. Mic Voice Ctrl plus Shift plus M."
                    >
                      <div className="flex items-center gap-1 leading-none whitespace-nowrap">
                        <Volume2 className="h-2.5 w-2.5 text-white/70" aria-hidden="true" />
                        <span className="text-[9px] text-white/75">Ctrl + M</span>
                      </div>
                      <div className="flex items-center gap-1 leading-none whitespace-nowrap">
                        <Mic className="h-2.5 w-2.5 text-white/70" aria-hidden="true" />
                        <span className="text-[9px] text-white/75">Ctrl + Shift + M</span>
                      </div>
                    </div>
                  ) : (
                  <>
          ...
          {updateInfo?.updateAvailable && (
            ...
            >
              ...
              >
                ...
                >
                  Download from{' '}
                    <span className="underline font-semibold">github.com/Aditya121raj/helper/releases</span>
