...
export class ShortcutsHelper {
  ...
  constructor(deps: IShortcutsHelperDeps) {
    ...
    this.shortcuts = {
      "CommandOrControl+Enter": () => {
        void this.deps.runScreenshotOperation();
      },
      "CommandOrControl+R": () => {
      ...
      "CommandOrControl+M": () => {
        console.log("Command/Ctrl + M pressed. Toggling Windows System Audio transcription.");
        this.deps.toggleVoiceRecording("system-audio");
      },
      "CommandOrControl+Shift+M": () => {
        console.log("Command/Ctrl + Shift + M pressed. Toggling microphone transcription.");
        this.deps.toggleVoiceRecording("microphone");
      },
  ...
  private registerAppShortcuts(): void {
    ...
    const criticalShortcuts = ["CommandOrControl+R", "CommandOrControl+M", "CommandOrControl+Shift+M"];
